...
handle_fx_plot_8bit:
        ...
        tst     vLow, #255                               @ If the color is transparent, return
        add     rDREG, r1, #1                            @ X++
        strh    rDREG, [rGSU, #FX_R1]                    @  |
        beq     handle_fx_plot_8bit.return               @ If the color is transparent, return
...
handle_fx_plot_8bit.common:
        and     r1, r1, #248                             @ X GSU.x[(X & 11111000) >> 3]
        add     r2, rGSU, r2, lsl #2                     @ Screen GSU.apvScreen[Y >> 3]
handle_fx_plot_8bit.common2:
        add     r1, rGSU, r1, lsr #1                     @ X
